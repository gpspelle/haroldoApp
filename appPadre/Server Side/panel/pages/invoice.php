...
if(($actionType != "send") && ($actionType != "delete"))
...
?>        
          <div id="page-wrapper">
            ...
            <!-- /.row -->    			
            <?php if(($actionType != "send") && ($actionType != "delete"))
			{?>
			 <div class="row">
                <div class="col-lg">
                        ...
                        <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									{										
										...
										echo '<td>'.($donation["Status"] == 0?'<a href="/panel/invoice/delete/'.$donation["Code"].'" class="btn btn-outline btn-default">Deletar</a>':"-").'</td>';
										echo '</tr>';
									}
									?>                                                                             
                                    </tbody>
				...
				{
					DonationManager::getInstance()->deleteDonation($invoiceId);
					echo '<div class="alert alert-success">	Nota deletada!</div>';
				}
				?>
			</div>               		
        <!-- /#page-wrapper -->
